...
Мне кажется, суть ровно такая же, только названия поддоменов и контекстов другие (разве что я в 3 домашке потерял стрелку от контекста "Вакансий" к "Биллингу воркеров" `¯\_(ツ)_/¯` ).  
...
Сам маппинг характеристик на Bounded Contexts можно посмотреть в [3 домашке](../3-week/task.md), раздел "Маппинг характеристик на bounded contexts".
