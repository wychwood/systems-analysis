...
- Назвать поддомен _"Решение задач клиентов"_ или _"Выполнение поручений клиентов"_, или _"Выполнение работы за клиента"_ (чтобы было похоже на проблему), а bounded context - _"Прием и выполнение заявок клиентов"_ (чтобы было похоже на решение)
- Назвать bounded context - _"Биржа заявок и исполнителей"_ (т.к. биржа это не проблема, а решение). Чтобы это стало маркетплейсом, должны быть _услуги_, которые будут _покупать_, а не _заявки_, которые надо исполнять, как оно у нас в требованиях.
...
На самые изначальные попытки нарисовать ES ушли часов 10 работы на отпуске в Тайланде.
